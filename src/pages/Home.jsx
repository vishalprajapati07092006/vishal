...
// 🌿 Unique, high-quality fallback images (E-Waste & Green Tech)
      ...
      <section className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-8 text-left z-10">
            ...
            >
              <FaAward className="text-emerald-500" /> Academic E-Portfolio • E-Waste Management
            </motion.div>
            ...
            >
              Comprehensive practical activities, device dissections, and sustainability reflections evaluated under institutional rubric standards.
            </motion.p>
            ...
            >
              ...
              >
                <FaLayerGroup className="mr-2 text-emerald-500" /> Browse Archive
              </Link>
            </motion.div>
          </div>
        ...
        {loading ? (
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {latestActivities.map((act, index) => {
              ...
              // 1. If admin uploaded imageURL, use act.imageURL
              // 2. Otherwise, pick a unique image from DEFAULT_ACTIVITY_IMAGES based on activityNumber or index
              const displayImage =
                  ...
                  <div className="p-6 flex-1 flex flex-col justify-between space-y-4">
                    <div className="space-y-2.5">
                      ...
                      <p className="text-xs text-gray-600 dark:text-gray-300 line-clamp-2 leading-relaxed">
                        {act.objective || act.whatILearned}
                      </p>
                    </div>
